...
class StudentDotsBoxGame (columns: Int, rows: Int, players: List<Player>): AbstractDotsAndBoxesGame() {
    override val players: List<Player> = players.toMutableList()//TODO("You will need to get players from your constructor")

    override val currentPlayer: Player
        get()= players[0]
    //TODO("Determine the current player, like keeping the index into the player list")
    ...
    override var isFinished: Boolean
        get() = this.isFinished //TODO("Provide this getter. Note you can make it a var to do so")
